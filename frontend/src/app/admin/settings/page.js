    ...
    <div className="animate-fade-in">
      ...
      <form onSubmit={handleSubmit} className="space-y-6 max-w-2xl">
        ...
        <button
          ...
          className="btn-primary text-sm py-2.5 flex items-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed dark:bg-brand-green dark:text-white dark:hover:bg-green-700"
        >
